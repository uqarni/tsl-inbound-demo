...
def main():
    ...
    how_many_times_have_you_been_paid_to_speak_ = st.selectbox("Times Paid to Speak", options = paid_options, index = 2)
    ...
    how_much_do_you_currently_make_per_month_speaking_ = st.selectbox("Lead Monthly Speaking Income", options = speaking_income, index = 3)
    ...
    what_industry_do_you_speak_in_or_hope_to_speak_in_ = st.selectbox("Lead Speaking Industry", options = industry_options, index = 1)
    ...
    what_is_your_desired_monthly_income_from_speaking_what_is_your_goal_ = st.selectbox("Lead Desired Monthly Income from Speaking", options = desired_income, index = 3)
